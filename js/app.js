...
function updateVotes(){
  for(var i = 0; i<allImages.length; i++){
    imageVotes.push(allImages[i].clickCount);

  }
}
function renderChart(){
  var context = document.getElementById('busmall-chart').getContext('2d');
  var arrayOfColor = ['red','green','blue','yellow','gray','red','green','blue','yellow','gray','red','green','blue','yellow','gray','red','green','blue','yellow','gray','red','green','blue','yellow','gray'];
  new Chart (context,{
    type :'bar',
    data:{
      labels:imageName,
